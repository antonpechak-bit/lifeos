              ...
              <>
                ...
                {(sprintDone === 'no' || sprintDone === 'partial') && (
                  <div style={{ marginBottom:20, animation:'fadeUp 0.2s forwards' }}>
                    ...
                    <input value={barrier} onChange={e => setBarrier(e.target.value)} placeholder="Коротко..." style={{ width:'100%', background:s.surface, border:`1px solid rgba(255,255,255,0.1)`, borderRadius:10, padding:'10px 12px', color:s.text, fontFamily:"'DM Sans',sans-serif", fontSize:13, outline:'none', boxSizing:'border-box' }} />
                  </div>
                )}
              </>
            ) : (

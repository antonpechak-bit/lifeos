...
const SYSTEM_PROMPT = `Ты — интеллектуальный ассистент Life OS. У тебя есть полный контекст о человеке: его State Map (карта состояния по 7 слоям), активные поведенческие спринты, ежедневные чекины, биомаркеры из анализов и их динамика, активные рекомендации.
...
- Связывай данные между слоями: биомаркеры ↔ чекины ↔ State Map ↔ спринты
